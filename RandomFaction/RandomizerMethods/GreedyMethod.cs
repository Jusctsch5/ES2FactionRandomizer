...
{
    class GreedyMethod : RandomizerMethod
    {
        public override CustomFaction GenerateRandomCustomFaction(TraitDefinitions iDefinitions, Preferences iPreferences)
        {
            ...
            iDefinitions._primaryPoliticsGroup.GetRandomPrimaryPolitics();
            ...
            foreach (int popTrait in populationTraits)
            {
                ...
                {
                    case 1:
                        faction._secondaryPolitics1 = iDefinitions._secondaryPoliticsGroup.GetRandomSecondaryPolitics(remainingPopTraitPoints);
                        break;
                    case 2:
                        faction._secondaryPolitics2 = iDefinitions._secondaryPoliticsGroup.GetRandomSecondaryPolitics(remainingPopTraitPoints);
                        break;
                    case 3:
            ...
            if (Preferences._guaranteeTechType == Preferences.GuaranteeTechType.Guarantee1Tech)

            if (iPreferences._scoreAdherence)
            int scoreRemaining = gameplayAffinity._scoreModifier;
